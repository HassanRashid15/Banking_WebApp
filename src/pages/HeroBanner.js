...
function HeroBanner() {
  ...
  <section class=" h-full">
    <div
      class="rounded-2xl bg-indigo-50 py-20 overflow-hidden my-5 lg:m-0 2xl:py-20 xl:py-20  lg:rounded-tl-2xl lg:rounded-bl-2xl ">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full" style={{maxWidth:'90%'}}>
